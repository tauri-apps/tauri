...
/// Resources can be created in endpoints. Resources can also be retrieved in endpoints by
...
impl Resource for Lines<BufReader<File>> {}
impl<T: Resource> Resource for Mutex<T> {}
impl<T: Resource> Resource for Mutex<Option<T>> {}
