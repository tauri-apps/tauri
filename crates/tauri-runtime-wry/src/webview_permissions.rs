...
pub(super) fn map_permission_kind(kind: wry::PermissionKind) -> PermissionKind {
  match kind {
...
pub(super) fn map_permission_response(response: PermissionResponse) -> wry::PermissionResponse {
  match response {
