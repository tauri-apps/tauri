import { defineConfig, presetIcons, presetUno, extractorSvelte, presetWebFonts } from "unocss";
...
export default defineConfig({
  ...
  shortcuts: {
    'btn': `select-none outline-none shadow-md p-2 rd-1 text-textPrimary border-none font-700
    ...
    'note': `decoration-none flex-inline items-center relative p-2 rd-1
             ...
             after:h-100% after:content-empty after:rd-l-1
             after:bg-accent dark:after:bg-darkAccent`,
    'note-red': 'note bg-red-700/10 dark:bg-red-700/10 after:bg-red-700 dark:after:bg-red-700',
    'input': 'h-10 flex items-center outline-none border-none p-2 rd-1 shadow-md bg-primaryLighter dark:bg-darkPrimaryLighter text-primaryText dark:text-darkPrimaryText',
  },
