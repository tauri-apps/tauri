...
- [`052e8b43`](https://www.github.com/tauri-apps/tauri/commit/052e8b4311d9f0f963a2866163be27bfd8f70c60)([#8838](https://www.github.com/tauri-apps/tauri/pull/8838)) **[SECURITY]** Downgrade minisign dependency fixing a critical updater signing key bug. Applications built with versions prior to `2.0.0-beta.2` had broken signature verification on update artifacts, which could allow an attacker performing a man-in-the-middle attack or compromising the update server to substitute a malicious update artifact that passes the broken signature check. **Users should upgrade to `2.0.0-beta.2` or later immediately.**
