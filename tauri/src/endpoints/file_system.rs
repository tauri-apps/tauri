...
/// Reads a directory.
#[cfg(read_dir)]
pub async fn read_dir<W: WebviewMut>(
  webview: &mut W,
  path: PathBuf,
...
/// Copies a file.
#[cfg(copy_file)]
pub async fn copy_file<W: WebviewMut>(
  webview: &mut W,
  source: PathBuf,
  destination: PathBuf,
...
/// Creates a directory.
#[cfg(create_dir)]
pub async fn create_dir<W: WebviewMut>(
  webview: &mut W,
  path: PathBuf,
  options: Option<DirOperationOptions>,
  callback: String,
...
/// Removes a directory.
#[cfg(remove_dir)]
pub async fn remove_dir<W: WebviewMut>(
  webview: &mut W,
  path: PathBuf,
  options: Option<DirOperationOptions>,
  callback: String,
...
/// Removes a file
#[cfg(remove_file)]
pub async fn remove_file<W: WebviewMut>(
  webview: &mut W,
  path: PathBuf,
  options: Option<FileOperationOptions>,
  callback: String,
...
/// Renames a file.
#[cfg(rename_file)]
pub async fn rename_file<W: WebviewMut>(
  webview: &mut W,
  old_path: PathBuf,
  new_path: PathBuf,
  options: Option<FileOperationOptions>,
...
/// Writes a text file.
#[cfg(write_file)]
pub async fn write_file<W: WebviewMut>(
  webview: &mut W,
  path: PathBuf,
  contents: String,
  options: Option<FileOperationOptions>,
...
pub async fn write_binary_file<W: WebviewMut>(
  webview: &mut W,
  path: PathBuf,
  contents: String,
  options: Option<FileOperationOptions>,
...
/// Reads a text file.
#[cfg(read_text_file)]
pub async fn read_text_file<W: WebviewMut>(
  webview: &mut W,
  path: PathBuf,
  options: Option<FileOperationOptions>,
  callback: String,
...
pub async fn read_binary_file<W: WebviewMut>(
  webview: &mut W,
  path: PathBuf,
  options: Option<FileOperationOptions>,
  callback: String,
